        ...
        <form onSubmit={handleSubmit} className="Auth-form">
          <div className="Auth-form-content">
            ...
            <div className="form-group mt-3">
              ...
              <input type="text" id="newPassword" className="form-control mt-1" placeholder="Mật khẩu mới"
                required ref={userRef} onChange={(e) => setAccount(e.target.value)}value={account} /> <button onClick={handleSend}></button>
            </div>
            <div className="form-group mt-3">

              <input type="text" id="confirmNewPassword" className="form-control mt-1" placeholder="Xác nhận mật khẩu"
