...
class AuthServiceImplTest {
    ...
    void registerUser() {
        ...
        System.out.println(responseEntity.toString());
        // Assert
        assertEquals(responseEntity.getBody(), "Đăng kí thành công, vui lòng đợi xác nhận tài khoản");
        //assertEquals(responseEntity.getBody(), "Fail");
    }
    ...
    void verifyOTP() {
        ...
        System.out.println(responseEntity.toString());
        // Assert
        assertEquals("Mã OTP sai",responseEntity.getBody());
    }
