 ...
 * 19/00/2023    1.0        DuongVV          First Deploy<br>
 */
...
public class SpeedSMS {
    ...
    public static final String TOKEN = "WPOWthpCWL1hR8MmLtBVlHFcvOewDM2v";
    ...
    public String getUserInfo() throws IOException {
        ...
        byte[] decodedBytes = Base64.getEncoder().encode(userCredentials.getBytes());
