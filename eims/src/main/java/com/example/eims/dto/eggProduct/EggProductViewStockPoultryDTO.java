...
@Data
@NamedNativeQuery(name="viewStockPoultry",
        query="SELECT ep.product_id, ep.egg_batch_id, ir.import_id, b.breed_id, b.breed_name, " +
                ...
                "AND eb.status = 0 " +
                "AND ip.phase_number IN (7, 8, 9) " +
                "AND ep.cur_amount > 0 " +
                "ORDER BY ep.incubation_date ",
        resultClass = EggProductViewStockPoultryDTO.class)

@Entity
public class EggProductViewStockPoultryDTO {
    @Id
